...
template <class Derived, class Enum_log_level> class AbstractSink {
    ...
    public:
        ...
        constexpr inline void log(Enum_log_level log_level, std::format_string<Args...> fmt, Args&&... args) noexcept {
        ...
        virtual void process_log(Enum_log_level log_level, std::string&&) noexcept = 0;
    protected:
